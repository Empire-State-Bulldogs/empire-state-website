    ...
    <section ref={ref} id="puppies" className="py-16 md:py-24 bg-card relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className={`text-center mb-20 md:mb-32 ${isVisible ? "scroll-fade-up" : "opacity-0"}`}>
          ...
          <h2 className="text-5xl md:text-7xl lg:text-8xl font-black mt-4 mb-8 text-card-foreground leading-[1.1] tracking-tight lowercase">
        ...
        <div className="max-w-6xl mx-auto mb-20">
          <Card className={`bg-secondary border-border overflow-hidden hover:border-primary/50 transition-all duration-300 group flex flex-col xl:flex-row shadow-2xl shadow-primary/5 ${isVisible ? "scroll-fade-up" : "opacity-0"}`}>
            <div className="relative aspect-video xl:aspect-auto min-h-[300px] xl:w-[40%] bg-muted flex items-center justify-center overflow-hidden shrink-0">
              <Image
            ...
            <div className="text-center md:text-left p-8 md:p-10 xl:p-14 flex flex-col justify-center flex-1">
              <div className="md:inline-block">
                <Badge variant="secondary" className="bg-primary text-white mb-6 px-4 py-1.5 text-lg md:text-xl font-black rounded-xl italic lowercase">
                  dropping soon!
                </Badge>
              </div>
              <h3 className="text-4xl md:text-5xl xl:text-6xl font-black text-card-foreground mb-6 tracking-tight leading-tight lowercase">new puppies coming soon</h3>
              ...
              <div>
                <Button
                  asChild
                  size="lg"
                  className="w-full md:w-auto bg-primary text-white hover:bg-primary/90 px-12 py-7 text-xl md:text-2xl font-black rounded-[1.5rem] shadow-xl shadow-primary/30 lowercase tracking-tight"
                >
