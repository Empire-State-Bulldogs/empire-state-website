            ...
            <div className="flex lg:hidden flex-1 items-center justify-center gap-1 px-2">
              ...
              >
                <div className="flex flex-col items-start overflow-hidden">
                  <span className="text-[10px] font-black uppercase tracking-widest text-primary leading-none">Now Playing</span>
                  <span className="text-[13px] font-bold text-foreground truncate w-full leading-snug">{currentTrack.title}</span>
                </div>
            ...
            <nav className="hidden lg:flex items-center gap-2">
              {navLinks.filter(l => l.href !== "/").map((link) => (
                <Link
                  ...
                  href={link.href}
                  className={cn(
                    "px-3 py-2 text-sm font-semibold rounded-lg transition-all hover:text-primary hover:bg-primary/8",
        ...
        <div className={cn(
          ...
          <div className="bg-background/98 backdrop-blur-xl border-t border-border px-4 pt-4 pb-8">
            ...
            <div className="space-y-1 mb-6">
              {navLinks.map((link, i) => (
                ...
                >
                  ...
                  {pathname === link.href && <div className="ml-auto w-2 h-2 rounded-full bg-primary" />}
                </Link>
              ))}
            </div>
            ...
            <div className="border-t border-border pt-4 mb-6">
              <p className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground mb-3 px-4">More Info</p>
              <div className="grid grid-cols-3 gap-2">
                {extraLinks.map((link) => (
                  ...
                  >
                    ...
                    <span className="text-xs font-bold text-foreground group-hover:text-primary leading-tight">{link.label}</span>
                  </Link>
                ))}
              </div>
            </div>
            ...
            <div className="border-t border-border pt-4 mb-5">
              <p className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground mb-3 px-4">Connect</p>
